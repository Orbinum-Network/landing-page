...
export const TermsPage = () => {
    return (
        <div className="max-w-6xl mx-auto px-4 py-8 text-secondary-200 pt-32">
            <SectionTitle title="Terms of Service" titleTwo="" />
            <Divider />
            ...
            {/* Sección 2: Description of Services */}
            ...
            {/* Sección 3: User Roles and Responsibilities */}
            ...
            {/* Sección 4: Intellectual Property */}
            ...
            {/* Sección 5: Privacy and Data Security */}
            ...
            {/* Sección 6: Economic Model and Token Usage */}
            ...
            {/* Sección 7: Prohibited Activities */}
            ...
            {/* Sección 8: Limitation of Liability */}
            ...
            {/* Sección 10: Modifications to Terms */}
            ...
            {/* Sección 12: Contact Information */}
